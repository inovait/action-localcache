...
const expand_tilde_1 = __importDefault(__nccwpck_require__(8248));
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const folder = (0, expand_tilde_1.default)(rawFolder);
            ...
            const tarProcess = (0, node_child_process_1.spawn)('tar', ['-cf', '-', '-C', parentFolder, folderName]);
            const authorization = `Bearer ${token}`;
            const resPromise = (0, node_fetch_1.default)(`http://build-docker-linux:25478/cache/${repo}/${key}`, {
                method: 'PUT',
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(5709);
